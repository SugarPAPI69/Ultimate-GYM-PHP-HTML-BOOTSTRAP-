...
<body>
    ...
    <div class="container" style="margin-top:30px">
        ...
        ?>
          ...
          <div class="row">
            <div class="col-12">
                <h2 class="bold text-center"><?php echo $row['expertise'] ?></h2>
                <hr>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-12">
                        <h4>Trainer First Name</h4>
                        <p class="mt-2"><?php echo $row['fname'] ?></p>
                        <hr>
                    </div>
                      <div class="col-12">
                        <h4>Trainer Last Name </h4>
                        <p class="mt-2">  <?php echo $row['lname']; ?></p>
                        <hr>
                    </div>
                    <div class="col-12">
                        <h4>Trainer Email</h4>
                     ...
                     <div class="col-12">
                        <h4>Trainer Phone number </h4>
                        <p class="mt-2">  <?php echo $row['phone']; ?></p>
                        <hr>
                    </div>
                    <div class="col-12">
                        <h4>Trainer Expertise</h4>
                        <p class="mt-2">  <?php echo $row['expertise']; ?></p>
                        <hr>
                    </div>
