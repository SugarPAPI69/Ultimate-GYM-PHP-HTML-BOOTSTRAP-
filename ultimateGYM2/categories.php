...
<body>
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="bold text-center">CLASSES</h2>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                <a href="Gym_class.php?category=Yoga">
                    <img src="images/categories/yoga.jpg" style="height:81%; width:100%">
                    <h6 class="text-center bold">YOGA</h6>
                </a>
            </div>
            <div class="col-3">
                <a href="Gym_class.php?category=Zumba">
                    <img src="images/categories/zumba.jpg" style="height:auto; width:100%">
                    <h6 class="text-center bold">ZUMBA</h6>
                </a>
            </div>
            <div class="col-3">
                <a href="Gym_class.php?category=Boxing">
                    <img src="images/categories/boxing.jpg" style="height:auto; width:100%">
                    <h6 class="text-center bold">BOXING</h6>
                </a>
            </div>
            <div class="col-3">
                <a href="Gym_class.php?category=Kick Boxing">
                    <img src="images/categories/kick_boxing.jpg" style="height:85%; width:100%">
                    <h6 class="text-center bold">KICK BOXING</h6>
                </a>
            </div>
        </div>
    ...
    <div class="modal fade" id="aboutModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <img src="images/developdgfers.png" style="height:auto; width:100%">
                </div>
            </div>
        </div>
    </div>
